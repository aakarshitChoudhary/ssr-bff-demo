...
// const edgeRouter = createEdgeRouter<NextRequest, NextResponse>();

// // Apply session middleware
// edgeRouter.use(applySession).get(async (req) => {
//   try {
...
export async function GET() {
  // return edgeRouter.run(request, res) as Promise<NextResponse>;
